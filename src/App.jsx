          ...
          <div>
            <div className="top-panels" style={{gap:12,marginBottom:12}}>
              ...
              <div className="panel" style={{display:'flex',flexDirection:'column',minHeight:340}}>
                ...
                <div style={{width:'100%',flex:1,overflow:'hidden',position:'relative',minHeight:280}}>
                  <iframe
                    ...
                    style={{width:'100%',height:'calc(100% + 32px)',border:'none',position:'absolute',top:0,left:0}}
